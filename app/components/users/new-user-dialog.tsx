...
export function NewUserDialog({ onSuccess }: { onSuccess?: () => void }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setFormData({ fullName: "", email: "", phone: "", password: "", role: "TECHNICIAN" });
            ...
            <DialogContent className="sm:max-w-[450px]">
                <form onSubmit={handleSubmit}>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Ingrese los detalles del usuario para registrarlo en el sistema.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                id="email"
                                type="email"
                                placeholder="usuario@mangro.com"
                        ...
                        <div className="grid gap-2">
                            ...
                            <select
                                ...
                                value={formData.role}
                                onChange={(e) =>
                                    setFormData({ ...formData, role: e.target.value as "ADMIN" | "TECHNICIAN" | "SUPERVISOR" })
                                }
                            >
