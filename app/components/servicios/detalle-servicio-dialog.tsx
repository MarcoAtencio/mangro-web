...
export function DetalleServicioDialog({
    service,
    tecnico,
    open,
    onOpenChange,
                        ...
                        <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100 relative group">
                            ...
                            <Button
                                ...
                                onClick={() =>
                                    openWhatsApp(
                                        tecnico?.phone,
                                        `Hola ${tecnico?.full_name}, tienes un servicio pendiente en ${service.clientName}...`
                                    )
                                }
                            >
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 space-y-2">
                            ...
                            <p className="text-slate-600 text-sm leading-relaxed italic">
                                &ldquo;{service.description || "Sin descripción adicional proporcionada."}
                                &rdquo;
                            </p>
